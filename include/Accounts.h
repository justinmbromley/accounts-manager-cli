...
public:
    ...
    // Deletes an account
    void delete_account(std::list<Account>::iterator it) const;
    ...
    std::list<Account>::const_iterator cbegin() const { return accounts.cbegin(); }
    std::list<Account>::const_iterator cend() const { return accounts.cend(); }
